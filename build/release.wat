(module
 ...
 (func $assembly/blockdata/transaction/Input#inscription (param $0 i32) (result i32)
  ...
  i32.const 0
  local.set $0
  block $__inlined_func$assembly/blockdata/witness/Witness#tapscript$990
   local.get $1
   i32.const 0
   i32.le_s
   br_if $__inlined_func$assembly/blockdata/witness/Witness#tapscript$990
   local.get $1
   i32.const 2
   i32.ge_s
   if (result i32)
 ...
 (func $~lib/util/string/strtol<f64> (param $0 i32) (result f64)
  ...
  local.set $0
  loop $while-continue|0
   block $__inlined_func$~lib/util/string/isSpace$679 (result i32)
    local.get $0
    i32.const 128
    i32.or
    i32.const 160
    ...
    i32.const 5760
    i32.lt_u
    br_if $__inlined_func$~lib/util/string/isSpace$679
    drop
    i32.const 1
    local.get $0
    i32.const -8192
    ...
    block $break|0
     ...
     i32.const 1
     br $__inlined_func$~lib/util/string/isSpace$679
    end
    i32.const 0
   end
   if
 ...
 (func $assembly/index/decodeHex (param $0 i32) (result i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    i32.const 5392
    local.set $1
    block $__inlined_func$~lib/string/String#substring$680
     local.get $6
     local.get $7
     local.get $6
     local.get $7
     ...
     local.tee $6
     i32.eqz
     br_if $__inlined_func$~lib/string/String#substring$680
     local.get $0
     local.set $1
     local.get $8
     i32.eqz
