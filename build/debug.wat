(module
 ...
 (global $~lib/memory/__heap_base i32 (i32.const 7132))
 (memory $0 1 32768)
 ...
 (func $assembly/utils/sha256/init
 ...
 (func $assembly/utils/sha256/hashBlocks (param $wPtr i32) (param $mPtr i32)
  (local $ptr i32)
  (local $offset i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    global.get $assembly/utils/sha256/i
    local.set $offset|14
    block $assembly/utils/sha256/load32be|inlined.0 (result i32)
     local.get $mPtr
     local.set $ptr
     global.get $assembly/utils/sha256/i
     local.set $offset
     ...
     block $assembly/utils/sha256/load8|inlined.0 (result i32)
      local.get $ptr
      local.set $ptr|5
      ...
      i32.add
      i32.load8_u
      br $assembly/utils/sha256/load8|inlined.0
     end
     i32.const 255
     i32.and
     i32.const 24
     i32.shl
     block $assembly/utils/sha256/load8|inlined.1 (result i32)
      local.get $ptr
      local.set $ptr|7
      local.get $firstOffset
      i32.const 1
      ...
      i32.add
      i32.load8_u
      br $assembly/utils/sha256/load8|inlined.1
     end
     i32.const 255
     i32.and
     i32.const 16
     i32.shl
     i32.or
     block $assembly/utils/sha256/load8|inlined.2 (result i32)
      local.get $ptr
      local.set $ptr|9
      local.get $firstOffset
      i32.const 2
      ...
      i32.add
      i32.load8_u
      br $assembly/utils/sha256/load8|inlined.2
     end
     i32.const 255
     i32.and
     i32.const 8
     i32.shl
     i32.or
     block $assembly/utils/sha256/load8|inlined.3 (result i32)
      local.get $ptr
      local.set $ptr|11
      local.get $firstOffset
      i32.const 3
      ...
      i32.add
      i32.load8_u
      br $assembly/utils/sha256/load8|inlined.3
     end
     i32.const 255
     i32.and
     i32.const 0
     i32.shl
     i32.or
     br $assembly/utils/sha256/load32be|inlined.0
    end
    local.set $u
    local.get $ptr|13
    local.get $offset|14
  ...
  loop $for-loop|1
   ...
   if
    ...
    global.get $assembly/utils/sha256/i
    local.set $offset|27
    block $assembly/utils/sha256/SIG1|inlined.0 (result i32)
     block $assembly/utils/sha256/load32|inlined.0 (result i32)
      local.get $wPtr
      local.set $ptr|16
      global.get $assembly/utils/sha256/i
      i32.const 2
      ...
      i32.add
      i32.load
      br $assembly/utils/sha256/load32|inlined.0
     end
     local.set $x
     local.get $x
     i32.const 17
     ...
     i32.shr_u
     i32.xor
     br $assembly/utils/sha256/SIG1|inlined.0
    end
    block $assembly/utils/sha256/load32|inlined.1 (result i32)
     local.get $wPtr
     local.set $ptr|19
     global.get $assembly/utils/sha256/i
     i32.const 7
     ...
     i32.add
     i32.load
     br $assembly/utils/sha256/load32|inlined.1
    end
    i32.add
    block $assembly/utils/sha256/SIG0|inlined.0 (result i32)
     block $assembly/utils/sha256/load32|inlined.2 (result i32)
      local.get $wPtr
      local.set $ptr|21
      global.get $assembly/utils/sha256/i
      i32.const 15
      ...
      i32.add
      i32.load
      br $assembly/utils/sha256/load32|inlined.2
     end
     local.set $x|23
     local.get $x|23
     i32.const 7
     ...
     i32.shr_u
     i32.xor
     br $assembly/utils/sha256/SIG0|inlined.0
    end
    i32.add
    block $assembly/utils/sha256/load32|inlined.3 (result i32)
     local.get $wPtr
     local.set $ptr|24
     global.get $assembly/utils/sha256/i
     i32.const 16
     ...
     i32.add
     i32.load
     br $assembly/utils/sha256/load32|inlined.3
    end
    i32.add
    local.set $u|28
    local.get $ptr|26
  ...
  loop $for-loop|2
   ...
   if
    ...
    block $assembly/utils/sha256/EP1|inlined.0 (result i32)
     ...
     i32.rotr
     i32.xor
     br $assembly/utils/sha256/EP1|inlined.0
    end
    i32.add
    block $assembly/utils/sha256/CH|inlined.0 (result i32)
     global.get $assembly/utils/sha256/e
     local.set $x|30
     ...
     i32.and
     i32.xor
     br $assembly/utils/sha256/CH|inlined.0
    end
    i32.add
    block $assembly/utils/sha256/load32|inlined.4 (result i32)
     ...
     i32.add
     i32.load
     br $assembly/utils/sha256/load32|inlined.4
    end
    i32.add
    block $assembly/utils/sha256/load32|inlined.5 (result i32)
     local.get $wPtr
     local.set $ptr|35
     global.get $assembly/utils/sha256/i
     local.set $offset|36
     ...
     i32.add
     i32.load
     br $assembly/utils/sha256/load32|inlined.5
    end
    i32.add
    global.set $assembly/utils/sha256/t1
    block $assembly/utils/sha256/EP0|inlined.0 (result i32)
     ...
     i32.rotr
     i32.xor
     br $assembly/utils/sha256/EP0|inlined.0
    end
    block $assembly/utils/sha256/MAJ|inlined.0 (result i32)
     global.get $assembly/utils/sha256/a
     local.set $x|38
     ...
     i32.and
     i32.xor
     br $assembly/utils/sha256/MAJ|inlined.0
    end
    i32.add
 ...
 (func $assembly/utils/sha256/update (param $dataPtr i32) (param $dataLength i32)
  (local $dataPos i32)
  (local $i i32)
  i32.const 0
  local.set $dataPos
 ...
 (func $assembly/utils/sha256/final (param $outPtr i32)
  (local $ptr i32)
  (local $offset i32)
  (local $u i32)
  (local $ptr|4 i32)
 ...
 (func $assembly/utils/sha256/sha256 (param $data i32) (result i32)
  (local $output i32)
  i32.const 0
  i32.const 32
  call $~lib/arraybuffer/ArrayBuffer#constructor
  local.set $output
  call $assembly/utils/sha256/init
  local.get $data
  local.get $data
  call $~lib/arraybuffer/ArrayBuffer#get:byteLength
  call $assembly/utils/sha256/update
  local.get $output
